...
from motion_from_texts import mdm_gen_motion_from_text
import numpy as np
...
class MotionScoresTokenLogitsProcessor(LogitsProcessor):
    ...
    def __call__(self, input_ids: torch.LongTensor, scores: torch.FloatTensor) -> torch.FloatTensor:
        ...
        for i,next_word in enumerate(next_words):
            ...
            mdm_gen_motion_from_text(self.model, self.cfg, sentence, x_motion_path, self.device, self.length)# , self.length
