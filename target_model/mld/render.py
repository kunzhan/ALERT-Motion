...
# print(os.path.dirname(random.__file__))
import natsort
# print(os.path.dirname(natsort.__file__))
...
def render_cli() -> None:
    ...
    cfg.ACCELERATOR = 'gpu'
    cfg.DEVICE = [3,0]
    cfg.RENDER.FACES_PATH = 'target_model/mld/deps/smpl_models/smplh.faces'
    cfg.RENDER.CANONICALIZE = False
    # cfg.RENDER.DOWNSAMPLE = True
