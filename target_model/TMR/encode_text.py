...
def encode_text(cfg: DictConfig) -> None:
    ...
    ckpt_name = 'last'
    text = "Lower limbs lift in steps, quick small movements simulate action, arms swing alternately, core maintains stability."# cfg.text
...
if __name__ == "__main__":
    # encode_text()
    import numpy as np
    e1 = np.load("target_model/TMR/models/tmr_humanml3d_guoh3dfeats/encoded/lower_limbs_lift_in_steps,_quick_small_movements_simulate_action,_arms_swing_alternately,_core_maintains_stability..npy")
    e2 = np.load("target_model/TMR/models/tmr_humanml3d_guoh3dfeats/encoded/running_in_place..npy")
